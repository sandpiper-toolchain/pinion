...
;****** Motor Setup	
;			  Closest motor in Wizard
;DMTR 34		;Motor ID (RE42B-XXP10 Parallel Winding)
;DMTSTT 2078.0		;Motor Static Torque (oz-in)
;DMTIC 4.92		;Continuous Current (Amps-RMS)
;DMTIND 10.6		;Motor Inductance (mH)
;DMTRES 0.47		;Motor Winding Resistance (Ohm)
;DMTJ 1130.330		;Motor Rotor Inertia (kg*m*m*10e-6)
;DPOLE 50		;Number of Motor Pole Pairs

;DIGNA 4.450		;Current Loop Gain A
;DIGNB 0.400		;Current Loop Gain B
;DIGNC 1.600		;Current Loop Gain C
;DIGND 0.980		;Current Loop Gain D
;
;Motor Setup
;DMTR 32		;Motor ID (RE42B-XXS10 Series Winding)
;DMTSTT 2075.0		;Motor Static Torque (oz-in)
;DMTIC 2.46		;Continuous Current (Amps-RMS)
;DMTIND 42.6		;Motor Inductance (mH)
;DMTRES 1.89		;Motor Winding Resistance (Ohm)
;DMTJ 1130.330		;Motor Rotor Inertia (kg*m*m*10e-6)
...
;*** Common winding settings Series/Parallel
DMTR 1
...
DRES  15000		;Drive Resolution (counts/rev)
ORES   200		;Encoder Output Resolution (counts/rev) 'assuming it is full steps per rev??Jim
DAUTOS 30.00	;Auto Current Standby (% reduction of motor current)
...
DSTALL  0		;Stall Detect Sensitivity, 0= disabled Zeta 6200 does stall detection
...
DWAVEF  2 ; MODELFLOOR	;Waveform (% of 3rd harmonic)
